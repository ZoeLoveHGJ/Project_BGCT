...
"""
Exp_1_Scalability.py: 算法可扩展性对比实验 (对应论文图5)
==============================================================================
本脚本用于生成论文中的 [Figure 5]，重点评估不同算法在标签数量增加时的
性能变化趋势（可扩展性）。

实验设计:
1.  **变量**: 标签总数 (TOTAL_TAGS)，从 1000 增加到 10000。
2.  **环境**: 理想信道 (BER=0, 无物理层噪声)，聚焦于MAC层防碰撞机制本身的效率。
3.  **对象**: algorithm_base_config.py 中定义的所有对比算法。
==============================================================================
"""
...
EXPERIMENT_NAME = "Exp7_Peak_Stack_Depth"
